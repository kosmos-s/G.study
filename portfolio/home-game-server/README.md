...
![Pterodactyl에서 관리 중인 게임 서버 목록](./images/03-pterodactyl-servers.png)
...
| Ubuntu 시스템 관리 | 게임 서버 관리 |
|---|---|
| ![Webmin 시스템 대시보드](./images/02-webmin-dashboard.png) | ![Pterodactyl 콘솔과 자원 사용량](./images/04-pterodactyl-console.png) |
...
| 실제 Minecraft 접속 | DiscordSRV 연동 |
|---|---|
| ![Minecraft 서버 플레이 화면](./images/05-minecraft-gameplay.png) | ![DiscordSRV 서버 알림](./images/06-discord-integration.png) |

### 백업 관리

![Pterodactyl 백업 목록](./images/07-backups.png)
...
- [구축 및 운영 증거 자료](./evidence.md) — 성능 측정값과 전체 화면 자료
